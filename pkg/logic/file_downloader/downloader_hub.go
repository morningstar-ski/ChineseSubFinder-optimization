...
// xunlei、shooter 使用这个
func (f *FileDownloader) Get(supplierName string, topN int64, subName string,
	...
	if found == false {
		...
		inSubInfo := supplier.NewSubInfo(supplierName, topN, subName, language.ChineseSimple, fileDownloadUrl, score, offset, ext, fileData)
